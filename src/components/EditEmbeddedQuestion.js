...
const EditEmbeddedQuestion = () => {
  ...
  const loadQuestion = async () => {
    try {
      const response = await fetch(`http://localhost:3000/embeddedquestions/${id}`);
  ...
  return (
    <Container className="my-4" style={{ maxWidth: '600px', backgroundColor: '#f4f4f9', padding: '20px', borderRadius: '8px' }}>
      <h2 className="mb-4" style={{ color: '#004080' }}>Edit Embedded Question</h2>
